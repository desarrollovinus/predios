	...
	<body>
		<div id="principal">
			...
			<?php if($this->uri->segment(1) != "sesion_controller") { ?>
				<ul id="menu">
					<li class="primero"><a class="inicio" href="<?php echo base_url(); ?>"><img border="0" title="Inicio" src="<?php echo base_url(); ?>img/inicio.png"><span> </span></a></li>
					<?php
					...
					// if(isset($permisos['Fichas']['Consultar'])) {
						?><li><a rel="gestion_social" href="<?php echo site_url('gestion_social_controller'); ?>"><span>Gesti&oacute;n social</span></a></li><?php
					// }
					...
					if($this->session->userdata('tipo_usuario') == 2) {
						?><li><a rel="administracion" href="<?php echo site_url('administracion_controller'); ?>"><span>Administrar</span></a></li><?php
					}
					?>

					<li><a rel="normas" href="<?php echo site_url('informes_controller/normas'); ?>"><span>Normas</span></a></li>
