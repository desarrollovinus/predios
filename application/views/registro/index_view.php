<div id="form">
	...
	<div id="accordion">
		...
		<div>
			...
			<?php echo form_fieldset('<b>Sem&aacute;foro</b>'); ?>
			<table style="text-align:'left'">
				<tbody>
					<tr>
						<td><?php echo form_label('Funci&oacute;n del predio en la obra','funcion_predio', "style='width: 30%;'"); ?></td>
						<?php
							$_funciones = array(' ' => ' ');
							...
							endforeach; 
						?>
						<td><?php echo form_dropdown('funcion_predio',$_funciones, $identificacion->id_funcion_predio, "style='width: 100%;'"); ?></td>
						...
						<?php
							...
							endforeach;
						?>
						<td><?php echo form_label('Estado de la v&iacute;a','estado_via', "style='width: 30%;'"); ?></td>
						<td><?php echo form_dropdown('estado_via',$_estados_via, $identificacion->id_estado_via, "style='width: 100%;'"); ?></td>
					</tr>
					<tr>
						<td><?php echo form_label('Estado del predio','estado_predio'); ?></td>
						<td>
				...
				<table style="text-align:left" width="100%">
					<tbody>
						...
						<tr>
							...
							<td><?php echo form_input('norte_long');?></td>
							<td><?php echo form_input('nom_norte');?></td>
						</tr>
						<tr>
							<td><?php echo form_label('SUR','sur_long'); ?></td>
							<td><?php echo form_input('sur_long');?></td>
							<td><?php echo form_input('nom_sur');?></td>
						</tr>
						<tr>
							<td><?php echo form_label('ORIENTE','oriente_long'); ?></td>
							<td><?php echo form_input('oriente_long');?></td>
							<td><?php echo form_input('nom_oriente');?></td>
						</tr>
						<tr>
							<td><?php echo form_label('OCCIDENTE','occidente_long'); ?></td>
							<td><?php echo form_input('occidente_long');?></td>
							<td><?php echo form_input('nom_occ');?></td>
						</tr>
					</tbody>
				</table>
			<?php echo form_fieldset_close(); ?>
			...
			<?php echo form_fieldset('<b>INVENTARIO DE CULTIVOS Y ESPECIES</b>'); ?>
				<table style="text-align:left" width="100%">
					<tbody>
						...
						<tr>
							<td>1. <?php echo form_input('cultivo_descr1');?></td>
							<td><?php echo form_input('cultivo_cant1');?></td>
							<td><?php echo form_input('cultivo_dens1');?></td>
							<td><?php echo form_input('cultivo_un1');?></td>
						</tr>
						<tr>
							<td>2. <?php echo form_input('cultivo_descr2');?></td>
							<td><?php echo form_input('cultivo_cant2');?></td>
							<td><?php echo form_input('cultivo_dens2');?></td>
							<td><?php echo form_input('cultivo_un2');?></td>
						</tr>
						<tr>
							<td>3. <?php echo form_input('cultivo_descr3');?></td>
							<td><?php echo form_input('cultivo_cant3');?></td>
							<td><?php echo form_input('cultivo_dens3');?></td>
							<td><?php echo form_input('cultivo_un3');?></td>
						</tr>
						<tr>
							<td>4. <?php echo form_input('cultivo_descr4');?></td>
							<td><?php echo form_input('cultivo_cant4');?></td>
							<td><?php echo form_input('cultivo_dens4');?></td>
							<td><?php echo form_input('cultivo_un4');?></td>
						</tr>
						<tr>
							<td>5. <?php echo form_input('cultivo_descr5');?></td>
							<td><?php echo form_input('cultivo_cant5');?></td>
							<td><?php echo form_input('cultivo_dens5');?></td>
							<td><?php echo form_input('cultivo_un5');?></td>
						</tr>
					</tbody>
				</table>
			<?php echo form_fieldset_close(); ?>
			...
			<?php echo form_fieldset('<b>DESCRIPCI&OacuteN DE LAS CONSTRUCCIONES</b>'); ?>
				<table style="text-align:left" width="100%">
					<tbody>
						...
						<tr>
							<td>1. <?php // echo form_input('const_item1');?></td>
							<td><?php echo form_input('const_desc1');?></td>
							<td><?php echo form_input('const_cant1');?></td>
							<td><?php echo form_input('const_un1');?></td>
						</tr>
						<tr>
							<td>2. <?php // echo form_input('const_item2');?></td>
							<td><?php echo form_input('const_desc2');?></td>
							<td><?php echo form_input('const_cant2');?></td>
							<td><?php echo form_input('const_un2');?></td>
						</tr>
						<tr>
							<td>3. <?php // echo form_input('const_item3');?></td>
							<td><?php echo form_input('const_desc3');?></td>
							<td><?php echo form_input('const_cant3');?></td>
							<td><?php echo form_input('const_un3');?></td>
						</tr>
						<tr>
							<td>4. <?php // echo form_input('const_item4');?></td>
							<td><?php echo form_input('const_desc4');?></td>
							<td><?php echo form_input('const_cant4');?></td>
							<td><?php echo form_input('const_un4');?></td>
						</tr>
						<tr>
							<td>5. <?php // echo form_input('const_item5');?></td>
							<td><?php echo form_input('const_desc5');?></td>
							<td><?php echo form_input('const_cant5');?></td>
							<td><?php echo form_input('const_un5');?></td>
						</tr>
					</tbody>
				</table>
			<?php echo form_fieldset_close(); ?>
			...
			<?php echo form_fieldset('<b>DESCRIPCI&Oacute;N DE LAS CONSTRUCCIONES ANEXAS</b>'); ?>
				<table style="text-align:left" width="100%">
					<tbody>
						...
						<tr>
							<td>1. <?php // echo form_input('const_an_item1');?></td>
							<td><?php echo form_input('const_an_desc1');?></td>
							<td><?php echo form_input('const_an_cant1');?></td>
							<td><?php echo form_input('const_an_un1');?></td>
						</tr>
						<tr>
							<td>2. <?php // echo form_input('const_an_item2');?></td>
							<td><?php echo form_input('const_an_desc2');?></td>
							<td><?php echo form_input('const_an_cant2');?></td>
							<td><?php echo form_input('const_an_un2');?></td>
						</tr>
						<tr>
							<td>3. <?php // echo form_input('const_an_item3');?></td>
							<td><?php echo form_input('const_an_desc3');?></td>
							<td><?php echo form_input('const_an_cant3');?></td>
							<td><?php echo form_input('const_an_un3');?></td>
						</tr>
						<tr>
							<td>4. <?php // echo form_input('const_an_item4');?></td>
							<td><?php echo form_input('const_an_desc4');?></td>
							<td><?php echo form_input('const_an_cant4');?></td>
							<td><?php echo form_input('const_an_un4');?></td>
						</tr>
						<tr>
							<td>5. <?php // echo form_input('const_an_item5');?></td>
							<td><?php echo form_input('const_an_desc5');?></td>
							<td><?php echo form_input('const_an_cant5');?></td>
							<td><?php echo form_input('const_an_un5');?></td>
						</tr>
					</tbody>
				</table>
				...
				<table style="text-align:left" width="100%">
					<tr>
						<td><input type="checkbox" id="c_licencia" name="c_licencia" value="1"></td>
					...
					<tr>
						<td><input type="checkbox" id="c_reglamento" name="c_reglamento" value="1"></td>
						<td>Tiene el inmueble reglamento de Propiedad Horizontal LEY 675 DE 2001?</td>
					</tr>
					<tr>
						<td><input type="checkbox" id="c_levantamiento" name="c_levantamiento" value="1"></td>
						<td>Tiene el inmueble aprobado plan parcial en el momento del levantamiento de la Ficha Predial?</td>
					</tr>
					<tr>
						<td><input type="checkbox" id="c_informe" name="c_informe" value="1"></td>
						<td>Aplica Informe de an&aacute;lisis de &Aacute;rea Remanente?</td>
					</tr>
					<tr>
						<td><input type="checkbox" id="c_adquisicion" name="c_adquisicion" value="1"></td>
				...
				<table style="text-align:left">
					<tbody>
						<tr>
							...
							<td width="30%"><?php echo form_dropdown('estado_ambiental', array('0' => 'No disponible', '1' => 'Disponible')); ?></td>
						...
						<tr>
							...
							<td width="30%"><?php echo form_dropdown('disponibilidad_izquierda', array('0' => 'No disponible - Negocio', '2' => 'No disponible - Expropiaci&oacute;n', '1' => 'Disponible')); ?></td>
							<td width="20%"><?php echo form_label('Disponibilidad derecha','disponibilidad_derecha'); ?></td>
							<td width="30%"><?php echo form_dropdown('disponibilidad_derecha', array('0' => 'No disponible - Negocio', '2' => 'No disponible - Expropiaci&oacute;n', '1' => 'Disponible')); ?></td>
						</tr>
					</tbody>
				</table>
			<?php echo form_fieldset_close(); ?>
				...
				<table style="text-align:left">
					<tbody>
						<tr>
							...
							<td width="30%"><?php echo form_input('fecha_remision_insumos'); ?></td>
