...
$objDrawing->setPath('./img/logo_vidnus.png');
...
$objDrawing2->setPath('./img/logdo_ani.jpg');
$objDrawing2->setCoordinates('B2');
$objDrawing2->setWidth(10);
$objDrawing2->setOffsetX(20);
$objDrawing2->setOffsetY(45);
...
$objPHPExcel->getActiveSheet()->mergeCells('S12:U12');
...
$objPHPExcel->getActiveSheet()->mergeCells('W12:Z12');
$objPHPExcel->getActiveSheet()->mergeCells('W13:Z13');
...
$objPHPExcel->getActiveSheet()->mergeCells('V5:Y8');
$objPHPExcel->getActiveSheet()->mergeCells('Z5:AD10');
$objPHPExcel->getActiveSheet()->mergeCells('AA12:AB12');
$objPHPExcel->getActiveSheet()->mergeCells('AA13:AB13');
...
$objPHPExcel->getActiveSheet()->getStyle('S12:U12')->applyFromArray($borde_puntos_externo);
$objPHPExcel->getActiveSheet()->getStyle('S12:U13')->applyFromArray($borde_puntos_externo);
...
$objPHPExcel->getActiveSheet()->getStyle('AA12:AB12')->applyFromArray($borde_puntos_externo);
$objPHPExcel->getActiveSheet()->getStyle('AA13:AB13')->applyFromArray($borde_puntos_externo);
...
$objPHPExcel->getActiveSheet()->getStyle("V5")->applyFromArray($negrita);
$objPHPExcel->getActiveSheet()->getStyle("V5")->applyFromArray($centrado);
$objPHPExcel->getActiveSheet()->getStyle("V5")->applyFromArray($tamanio8);
...
$objPHPExcel->getActiveSheet()->getStyle("V12:Z13")->applyFromArray($arial);
$objPHPExcel->getActiveSheet()->getStyle("V12:Z13")->applyFromArray($negrita);
$objPHPExcel->getActiveSheet()->getStyle("V12:Z13")->applyFromArray($tamanio8);
...
$objPHPExcel->getActiveSheet()->setCellValue('Q12', 'ABSC. INICIAL');
$objPHPExcel->getActiveSheet()->setCellValue('Q13', 'ABSC. FINAL');
...
$objPHPExcel->getActiveSheet()->setCellValue('V2', 'APP - VINUS');
$objPHPExcel->getActiveSheet()->setCellValue('V5', 'SECTOR O TRAMO');
$objPHPExcel->getActiveSheet()->setCellValue('W12', 'MARGEN');
$objPHPExcel->getActiveSheet()->setCellValue('W13', 'LONGITUD EFECTIVA');
...
$objPHPExcel->getActiveSheet()->setCellValue('S12', $predio->abscisa_inicial);
$objPHPExcel->getActiveSheet()->setCellValue('S13', $predio->abscisa_final);
...
$objPHPExcel->getActiveSheet()->setCellValue('U16', $predio->documento);
...
$objPHPExcel->getActiveSheet()->setCellValue('AA12', $predio->margen);
$objPHPExcel->getActiveSheet()->setCellValue('AA13', '=S13-S12');
...
$objPHPExcel->getActiveSheet()->setCellValue('AB37', "=SUM(AB32:AB36)");
// Recorrido de cultivos y especies
$fila = 33;
foreach ($this->PrediosDAO->obtener_cultivos($ficha) as $cultivo){
...
*********************************************************************/
// Nueva hoja
// $registro_fotografico = $objPHPExcel->createSheet();

// Título de la hoja
$registro_fotografico->setTitle("Reg. fotográfico");
...
$objDrawing->getShadow()->setDirection(160);
$objDrawing->setWorksheet($registro_fotografico);
...
$objDrawing2->setHeight(45);
$objDrawing2->setOffsetX(30);
$objDrawing2->setOffsetY(2);
$objDrawing2->setWorksheet($registro_fotografico);

// Se indica el rango de filas que se van a repetir en el momento de imprimir. (Encabezado del reporte)
$registro_fotografico->getPageSetup()->setRowsToRepeatAtTopByStartAndEnd(7);

/*
 * Definicion de la anchura de las columnas
 */
$registro_fotografico->getColumnDimension('A:J')->setWidth(11);

//Tamaño de celdas
$registro_fotografico->getRowDimension(4)->setRowHeight(5);
$registro_fotografico->getRowDimension(5)->setRowHeight(20);
$registro_fotografico->getRowDimension(6)->setRowHeight(20);
$registro_fotografico->getRowDimension(7)->setRowHeight(5);

//Celdas a combinar
$registro_fotografico->mergeCells('A1:B3');
$registro_fotografico->mergeCells('A5:F5');
$registro_fotografico->mergeCells('A6:F6');
$registro_fotografico->mergeCells('C1:H1');
$registro_fotografico->mergeCells('C2:H2');
$registro_fotografico->mergeCells('C3:H3');
$registro_fotografico->mergeCells('G5:J5');
$registro_fotografico->mergeCells('G6:J6');
$registro_fotografico->mergeCells('I1:J3');

//Encabezados
$registro_fotografico->setCellValue('C1', 'AGENCIA NACIONAL DE INFRAESTRUCTURA');
$registro_fotografico->setCellValue('C2', 'CONCESIÓN VIAL VÍAS DEL NUS S.A.S.');
$registro_fotografico->setCellValue('C3', 'REGISTRO FOTOGRÁFICO');
$registro_fotografico->setCellValue('A5', 'SEDE / PROYECTO: PRADERA - SAN JOSÉ DEL NUS');
$registro_fotografico->setCellValue('G5', 'FRENTE / ÁREA: GESTIÓN SOCIO - PREDIAL');
$registro_fotografico->setCellValue('A6', 'PREDIO NRO. '.$ficha);
$registro_fotografico->setCellValue('G6', 'FECHA: '.date("d-m-Y"));

// Estilos
$registro_fotografico->getStyle("C1:G2")->applyFromArray($negrita);
$registro_fotografico->getStyle("A5:G6")->applyFromArray($tamanio8);
...
foreach(glob($directorio.'*', GLOB_NOSORT) as $foto){
	...
	// $objDrawing3->setName('Logo ANI');
	// $objDrawing3->setDescription('Logo de uso exclusivo de ANI');
	$objDrawing3->setPath($foto);
	$objDrawing3->setCoordinates("A{$fila2}");
	$objDrawing3->setHeight(320);
	$objDrawing3->setOffsetX(30);
	$objDrawing3->setOffsetY(2);
	$objDrawing3->setWorksheet($registro_fotografico);

	$objDrawing4 = new PHPExcel_Worksheet_Drawing();
	$objDrawing4->setPath($foto);
	$objDrawing4->setCoordinates("F{$fila2}");
	$objDrawing4->setHeight(320);
	$objDrawing4->setOffsetX(30);
	$objDrawing4->setOffsetY(2);
	$objDrawing4->setWorksheet($registro_fotografico);

	$registro_fotografico->setCellValue("A{$fila}", "FOTO ".$cont++);
	// $registro_fotografico->setCellValue("A{$fila2}", $foto);
	$registro_fotografico->setCellValue("F{$fila}", "FOTO ".$cont++);
	// $registro_fotografico->setCellValue("F{$fila2}", $foto);
...
//Pié de página
$registro_fotografico->getHeaderFooter()->setOddFooter('&L&B' .$objPHPExcel->getProperties()->getTitle() . '&RPágina &P de &N');
